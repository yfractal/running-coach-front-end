<template>
  <div class="w-full h-full">
    <h3 class="text-lg font-medium text-gray-900 mb-4">Weekly Duration & Heart Rate</h3>
    ...
    datasets: [
      {
        ...
        data: weeks.map(([, weekData]) => weekData.total_duration_hours || 0),
    ...
    tooltip: {
      callbacks: {
        label: (context) => {
          ...
          const metric = context.dataset.label.includes('Duration') ? 'h' : 'bpm'
